...
-- ----------------------------
-- Table structure for exa_order
-- ----------------------------
DROP TABLE IF EXISTS `exa_order`;
CREATE TABLE `exa_order` (
  `order_id` bigint(50) NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `user_id` bigint(50) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `order_status` int(1) DEFAULT '0' COMMENT '订单状态 0未确认 1已确认 2已取消 3无效 4退款',
  `pay_status` int(1) DEFAULT '0' COMMENT '支付状态 0未支付 1支付中 2已支付',
  `shipping_status` int(1) DEFAULT '0' COMMENT '发货状态 0未发货 1已发货 2已退货',
  `address` varchar(255) DEFAULT '' COMMENT '收货地址',
  `consignee` varchar(255) DEFAULT '' COMMENT '收货人',
  `goods_id` bigint(50) NOT NULL DEFAULT '0' COMMENT '商品ID',
  `goods_number` int(11) NOT NULL DEFAULT '0' COMMENT '商品数量',
  `goods_price` decimal(10,2) DEFAULT '0.00' COMMENT '商品价格',
  `goods_amount` decimal(10,2) DEFAULT '0.00' COMMENT '商品总价',
  `shipping_fee` decimal(10,2) DEFAULT '0.00' COMMENT '运费',
  `order_amount` decimal(10,2) DEFAULT '0.00' COMMENT '订单价格',
  `coupon_id` bigint(50) DEFAULT '0' COMMENT '优惠券ID',
  `coupon_paid` decimal(10,2) DEFAULT '0.00' COMMENT '优惠券',
  `money_paid` decimal(10,2) DEFAULT '0.00' COMMENT '已付金额',
  `pay_amount` decimal(10,2) DEFAULT '0.00' COMMENT '支付金额',
  `add_time` datetime DEFAULT '1900-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `confirm_time` datetime DEFAULT '1900-01-01 00:00:00' COMMENT '订单确认时间',
  `pay_time` datetime DEFAULT '1900-01-01 00:00:00' COMMENT '支付时间',
...
CREATE TABLE `goods_order_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='订单商品日志表';
...
CREATE TABLE `producer_msg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='MQ消息生产表';
